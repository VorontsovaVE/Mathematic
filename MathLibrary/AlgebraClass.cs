...
namespace MathematicsLibrary
{
    public class AlgebraClass
    {
        ...
        {
            //Задание алгебра: корни квадратного уравнения, корни линейного уравнения, сумма ряда, максимальное из ряда, среднее значение ряда
